...
function edd_sl_add_renewals_view( $views ) {
	$views['renewals'] = __( 'License Renewals', 'templify_sl' );
	$views['upgrades'] = __( 'License Upgrades', 'templify_sl' );
	return $views;
}
...
function edd_sl_show_renewals_graph() {
	...
	if ( ! current_user_can( 'view_shop_reports' ) ) {
		wp_die( __( 'You do not have permission to view this data', 'templify_sl' ), __( 'Error', 'templify_sl' ), array( 'response' => 401 ) );
	}
	...
	$data = array(
		__( 'License Renewals', 'templify_sl' ) => $data,
	);
	?>
	<div class="metabox-holder" class="edd-sl-graph-controls">
		<div class="postbox">
			<h3><span><?php esc_html_e( 'License Renewals Over Time', 'templify_sl' ); ?></span></h3>
			...
			<div class="inside">
				...
				<p id="edd_graph_totals">
					<strong>
						<?php esc_html_e( 'Total renewal earnings for period shown: ', 'templify_sl' ); echo esc_html( edd_currency_filter( edd_format_amount( $totals ) ) ); ?>
					</strong>
				</p>
			</div>
		</div>
...
function edd_sl_show_upgrades_graph() {
	...
	$data = array(
		__( 'License Upgrades', 'templify_sl' ) => $data
	);
	?>

	<div class="metabox-holder" style="padding-top: 0;">
		<div class="postbox">
			<h3><span><?php _e( 'License Upgrades', 'templify_sl' ); ?></span></h3>
			...
			<div class="inside">
				...
				?>
				<p id="edd_graph_totals">
					<strong><?php _e( 'Total earnings from upgrades period shown: ', 'templify_sl' ); echo edd_currency_filter( edd_format_amount( $total ) ); ?></strong>
				</p>
			</div>
		</div>
	</div>
