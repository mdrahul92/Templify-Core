...
function edd_sl_license_export_box() {
	?>
	<div class="postbox">
		<h3><span><?php _e( 'Export License Keys', 'templify_sl' ); ?></span></h3>
		<div class="inside">
			<p><?php _e( 'Use this tool to export license keys to a CSV file.', 'templify_sl' ); ?></p>
			<form id="edd-sl-export-license-keys" class="edd-export-form edd-import-export-form" method="post">
				...
				<select name="edd_sl_status">
					<option value="all"><?php _e( 'All License Keys', 'templify_sl' ); ?></option>
					<option value="active"><?php _e( 'Active License Keys', 'templify_sl' ); ?></option>
					<option value="inactive"><?php _e( 'Inactive License Keys', 'templify_sl' ); ?></option>
					<option value="expired"><?php _e( 'Expired License Keys', 'templify_sl' ); ?></option>
				</select>
				...
				<button type="submit" class="button button-secondary"><?php esc_html_e( 'Export Keys', 'templify_sl' ); ?></button>
			</form>
		</div><!-- .inside -->
	</div><!-- .postbox -->
	<?php
