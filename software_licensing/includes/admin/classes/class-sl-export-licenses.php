...
class EDD_SL_License_Export extends EDD_Batch_Export {
	...
	public function csv_cols() {
		$cols = array(
			'id'          => __( 'License ID', 'templify_sl' ),
			'license'     => __( 'License Key', 'templify_sl' ),
			'status'      => __( 'License Status', 'templify_sl' ),
			'customer_id' => __( 'Customer ID', 'templify_sl' ),
			'email'       => __( 'Customer Email', 'templify_sl' ),
			'name'        => __( 'Customer Name', 'templify_sl' ),
			'user_id'     => __( 'User ID', 'templify_sl' ),
			'product'     => __( 'Product Name', 'templify_sl' ),
			'price_id'    => __( 'Price ID', 'templify_sl' ),
			'date'        => __( 'Purchase Date', 'templify_sl' ),
			'expiration'  => __( 'Expiration Date', 'templify_sl' ),
			'limit'       => __( 'Activation Limit', 'templify_sl' ),
			'count'       => __( 'Activation Count', 'templify_sl' ),
			'urls'        => __( 'Activated URLs', 'templify_sl' ),
		);
