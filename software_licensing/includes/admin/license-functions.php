...
function edd_sl_register_default_license_tabs( $tabs ) {
	...
	$default_tabs = array(
		'overview' => array( 'dashicon' => 'dashicons-lock', 'title' => __( 'Details', 'templify_sl' ) ),
		'logs'     => array( 'dashicon' => 'dashicons-book', 'title' => __( 'Logs', 'templify_sl' ) ),
	);
...
function edd_sl_register_delete_license_tab( $tabs ) {
	if ( current_user_can( 'delete_licenses' ) ) {
		$tabs['delete'] = array( 'dashicon' => 'dashicons-trash', 'title' => __( 'Delete', 'templify_sl' ) );
	}
