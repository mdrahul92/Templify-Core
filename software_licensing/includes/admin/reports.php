...
function edd_sl_add_log_views( $views ) {
	$views['renewal_notices'] = __( 'License Renewal Notices', 'templify_sl' );
	return $views;
}
...
function edd_sl_register_reports( $reports ) {
	...
	try {
		...
		$reports->add_report( 'software_licensing_renewals', array(
			'label'     => __( 'License Renewals', 'templify_sl' ),
			'icon'      => 'chart-area',
			'priority'  => 50,
			'endpoints' => array(
				'tiles' => array(
		...
		$reports->register_endpoint( 'software_licensing_renewals_number', array(
			'label' => __( 'Number of Renewals', 'templify_sl' ),
			'views' => array(
				'tile' => array(
		...
		$reports->register_endpoint( 'software_licensing_renewal_earnings', array(
			'label' => __( 'Renewal Earnings', 'templify_sl' ),
			'views' => array(
				'tile' => array(
		...
		$reports->add_report( 'software_licensing_upgrades', array(
			'label'     => __( 'License Upgrades', 'templify_sl' ),
			'icon'      => 'chart-area',
			'priority'  => 51,
			'endpoints' => array(
				'tiles' => array(
		...
		$reports->register_endpoint( 'software_licensing_upgrades_number', array(
			'label' => __( 'Number of Upgrades', 'templify_sl' ),
			'views' => array(
				'tile' => array(
		...
		$reports->register_endpoint( 'software_licensing_upgrade_earnings', array(
			'label' => __( 'Upgrade Earnings', 'templify_sl' ),
			'views' => array(
				'tile' => array(
