...
class EDD_SL_Requirements {
	...
	private function unmet_requirements_description_text() {
		...
		return esc_html__( '%1$s: minimum required %2$s (you have %3$s)', 'templify_sl' );
	}
	...
	private function unmet_requirements_missing_text() {
		...
		return wp_kses( __( '<strong>Missing %1$s</strong>: minimum required %2$s', 'templify_sl' ), array( 'strong' => array() ) );
	}
