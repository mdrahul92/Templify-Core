...
class EDD_SL_Download extends EDD_Download {
	...
	public function get_expiration_unit_nicename( $price_id = false ) {
		...
		switch( $exp_unit ) {
			case 'years':
				$singular = __( 'Year', 'templify_sl' );
				$plural   = __( 'Years', 'templify_sl' );
				break;

			case 'months':
				$singular = __( 'Month', 'templify_sl' );
				$plural   = __( 'Months', 'templify_sl' );
				break;

			case 'weeks':
				$singular = __( 'Week', 'templify_sl' );
				$plural   = __( 'Weeks', 'templify_sl' );
				break;

			case 'days':
			default:
				$singular = __( 'Day', 'templify_sl' );
				$plural   = __( 'Days', 'templify_sl' );
				break;
		}

		return ucfirst( _n( $singular, $plural, $this->get_expiration_length( $price_id ), 'templify_sl' ) );
	}
