...
function edd_sl_admin_scripts() {
	...
	if( $screen->id === 'download' ) {
		wp_localize_script( 'edd-sl-admin', 'templify_sl', array(
			'download'      => get_the_ID(),
			'no_prices'     => __( 'N/A', 'templify_sl' ),
			'add_banner'    => __( 'Add Banner', 'templify_sl' ),
			'use_this_file' => __( 'Use This Image', 'templify_sl' ),
		...
		wp_localize_script( 'edd-sl-admin', 'templify_sl', array(
			...
			'delete_license'    => __( 'Are you sure you wish to delete this license?', 'templify_sl' ),
			'action_edit'       => __( 'Edit', 'templify_sl' ),
			'action_cancel'     => __( 'Cancel', 'templify_sl' ),
			'send_notice'       => __( 'Send Renewal Notice', 'templify_sl' ),
			'cancel_notice'     => __( 'Cancel Renewal Notice', 'templify_sl' ),
			'regenerate_notice' => __( 'Regenerating a license key is not reversible. Click "OK" to continue.', 'templify_sl' ),
		) );
	}
