...
function _eddsl_get_meta_backcompat( $value, $object_id, $meta_key, $single ) {
	...
	if ( ! empty( $property ) ) {
		...
		$message = sprintf( __( 'The %s postmeta is <strong>deprecated</strong> since EDD Software Licensing 3.6! Use the EDD_SL_License object to get the %s property, instead.', 'templify_sl' ), $meta_key, $property );
...
function _eddsl_add_meta_backcompat( $check, $object_id, $meta_key, $meta_value, $unique ) {
	...
	if ( ! empty( $property ) ) {
		...
		$message = sprintf( __( 'The %s postmeta is <strong>deprecated</strong> since EDD Software Licensing 3.6! Use the EDD_SL_License object to set the %s property, instead.', 'templify_sl' ), $meta_key, $property );
...
function _eddsl_update_meta_backcompat( $check, $object_id, $meta_key, $meta_value, $prev_value ) {
	...
	if ( ! empty( $property ) ) {
		...
		$message = sprintf( __( 'The %s postmeta is <strong>deprecated</strong> since EDD Software Licensing 3.6! Use the EDD_SL_License object to update the %s property, instead.', 'templify_sl' ), $meta_key, $property );
...
function _eddsl_delete_meta_backcompat( $check, $object_id, $meta_key, $meta_value, $delete_all ) {
	...
	$property = eddsl_get_property_from_legacy_key( $meta_key );
	if ( ! empty( $property ) ) {
		$message = sprintf( __( 'The %s postmeta is <strong>deprecated</strong> since EDD Software Licensing 3.6! Use the EDD_SL_License object manage properties.', 'templify_sl' ), $meta_key, $property );
	} else {
