...
?>
<p><a href="<?php echo esc_url( remove_query_arg( array( 'view', 'license_id', 'edd_sl_error', '_wpnonce' ) ) ); ?>" class="edd-manage-license-back edd-submit button <?php echo esc_attr( $color ); ?>"><?php _e( 'Go back', 'templify_sl' ); ?></a></p>
...
<table id="edd_sl_license_upgrades" class="edd_sl_table edd-table">
	<thead>
		<tr class="edd_sl_license_row">
			...
			<th class="edd_sl_actions"><?php _e( 'Upgrade Cost', 'templify_sl' ); ?></th>
	...
	<?php if ( $upgrades ) : ?>
		<?php foreach ( $upgrades as $upgrade_id => $upgrade ) : ?>
			<tr class="edd_sl_license_row">
				...
				<td><a href="<?php echo esc_url( edd_sl_get_license_upgrade_url( $license_id, $upgrade_id ) ); ?>" title="<?php esc_attr_e( 'Upgrade License', 'templify_sl' ); ?>"><?php _e( 'Upgrade License', 'templify_sl' ); ?></a></td>
	...
	<?php else: ?>
		<tr class="edd_sl_license_row">
			<?php do_action( 'edd_sl_license_upgrades_row_start', $license_id ); ?>
			<td colspan="3"><?php _e( 'No upgrades available for this license', 'templify_sl' ); ?></td>
			<?php do_action( 'edd_sl_license_upgrades_row_end', $license_id ); ?>
		</tr>
	<?php endif; ?>
</table>
