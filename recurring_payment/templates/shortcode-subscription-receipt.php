...
<h3><?php esc_html_e( 'Subscription Details', 'templify-recurring' ); ?></h3>
...
<table id="edd_subscription_receipt">
	...
	<?php foreach ( $subscriptions as $subscription ) :
		...
		<tr>
			...
			<td>
				<span class="edd_subscription_times_billed"><?php echo $subscription->get_times_billed() . ' / ' . ( ( $subscription->bill_times == 0 ) ? __( 'Until cancelled', 'templify-recurring' ) : $subscription->bill_times ); ?></span>
			</td>
			<td>
