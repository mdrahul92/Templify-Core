...
?>
<a href="<?php echo esc_url( $action_url ); ?>">&larr;&nbsp;<?php esc_html_e( 'Back', 'templify-recurring' ); ?></a>
<h3><?php esc_html_e( 'Transactions for Subscription #', 'templify-recurring' ); ?><?php echo esc_html( $subscription->id ); ?></h3>
<table class="edd-recurring-subscription-transactions">
	<thead>
		<tr>
			<th><?php esc_html_e( 'Order', 'templify-recurring' ); ?></th>
			<th><?php esc_html_e( 'Order Amount', 'templify-recurring' ); ?></th>
			<th><?php esc_html_e( 'Order Date', 'templify-recurring' ); ?></th>
		</tr>
	</thead>
	<tbody>
		<?php
			...
			<tr>
				<td>
					...
					if ( $payment->ID == $subscription->parent_payment_id ) {
						echo ' ' . esc_html__( '(original order)', 'templify-recurring' );
					}
					?>
				</td>
