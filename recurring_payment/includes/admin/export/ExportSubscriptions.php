...
class ExportSubscriptions extends \EDD_Batch_Export {
	...
	public function csv_cols() {
		return array(
			'id'                 => __( 'Subscription ID', 'templify-recurring' ),
			'customer_id'        => __( 'Customer ID', 'templify-recurring' ),
			'customer_email'     => __( 'Customer Email', 'templify-recurring' ),
			'period'             => __( 'Billing Period', 'templify-recurring' ),
			'currency'           => __( 'Currency', 'templify-recurring' ),
			'initial_amount'     => __( 'Initial Amount', 'templify-recurring' ),
			'initial_tax_rate'   => __( 'Initial Tax Rate', 'templify-recurring' ),
			'initial_tax'        => __( 'Initial Tax Amount', 'templify-recurring' ),
			'recurring_amount'   => __( 'Recurring Amount', 'templify-recurring' ),
			'recurring_tax_rate' => __( 'Recurring Tax Rate', 'templify-recurring' ),
			'recurring_tax'      => __( 'Recurring Tax Amount', 'templify-recurring' ),
			'bill_times'         => __( 'Bill Times', 'templify-recurring' ),
			'transaction_id'     => __( 'Transaction ID', 'templify-recurring' ),
			'parent_payment_id'  => __( 'Order ID', 'templify-recurring' ),
			'product_id'         => __( 'Product ID', 'templify-recurring' ),
			'price_id'           => __( 'Product Price ID', 'templify-recurring' ),
			'created'            => __( 'Start Date', 'templify-recurring' ),
			'expiration'         => __( 'Expiration Date', 'templify-recurring' ),
			'trial_period'       => __( 'Trial Period', 'templify-recurring' ),
			'status'             => __( 'Status', 'templify-recurring' ),
			'profile_id'         => __( 'Gateway Profile ID', 'templify-recurring' ),
