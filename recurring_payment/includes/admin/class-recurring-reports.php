...
class EDD_Recurring_Reports {
	...
	public function register_reports( $reports ) {
		try {
			...
			$reports->add_report( 'recurring_subscription_renewals', array(
				'label'     => __( 'Subscription Renewals', 'templify-recurring' ),
			...
			$reports->register_endpoint( 'recurring_subscription_renewals_number', array(
				'label' => __( 'Number of Renewals', 'templify-recurring' ),
				'views' => array(
					'tile' => array(
			...
			$reports->register_endpoint( 'recurring_subscription_renewals_refunded_number', array(
				'label' => __( 'Number of Refunded Renewals', 'templify-recurring' ),
				'views' => array(
					'tile' => array(
			...
			$reports->register_endpoint( 'recurring_subscription_renewals_gross_earnings', array(
				'label' => __( 'Gross Renewal Earnings', 'templify-recurring' ),
				'views' => array(
					'tile' => array(
			...
			$reports->register_endpoint( 'recurring_subscription_renewals_refunded_amount', array(
				'label' => __( 'Refunded Renewals', 'templify-recurring' ),
				'views' => array(
					'tile' => array(
						'data_callback' => function() {
			...
			$reports->register_endpoint( 'recurring_subscription_renewals_net_earnings', array(
				'label' => __( 'Net Renewal Earnings', 'templify-recurring' ),
				'views' => array(
					'tile' => array(
						'data_callback' => function() {
				...
				'views' => array(
					'chart' => array(
						...
						'options'       => array(
							'datasets' => array(
								'renewals' => array(
									'label'                => __( 'Renewals', 'templify-recurring' ),
								...
								'refunds' => array(
									'label'                => __( 'Refunds', 'templify-recurring' ),
								...
								'earnings' => array(
									'label'                => __( 'Earnings', 'templify-recurring' ),
								...
								'refunded_earnings' => array(
									'label'                => __( 'Refunded Earnings', 'templify-recurring' ),
	...
	public function add_subscriptions_reports_view( $views ) {
		$views['subscriptions'] = __( 'Subscription Renewals', 'templify-recurring' );
	...
	public function display_subscriptions_report() {
		...
		if ( ! current_user_can( 'view_shop_reports' ) ) {
			wp_die( __( 'You do not have permission to view this data', 'templify-recurring' ), __( 'Error', 'templify-recurring' ), array( 'response' => 401 ) );
		}
		...
		$data = array(
			...
			__( 'Refunds', 'templify-recurring' )           => $refunded_counter,
			__( 'Earnings', 'templify-recurring' )          => $earnings_data,
			__( 'Refunded Earnings', 'templify-recurring' ) => $refunds_data,
		);
		...
		<div class="metabox-holder">
			<div class="postbox">
				<h3><span><?php _e( 'Subscription Renewals', 'templify-recurring' ); ?></span></h3>
				...
				<div class="inside">
					...
					<p class="edd_graph_totals">
						<strong><?php _e( 'Total renewals for period shown: ', 'templify-recurring' ); echo edd_format_amount( $subscriptions_totals, false ); ?></strong>
					</p>
	...
	public function status_column( $value, $payment_id, $column_name ) {
		...
		if ( 'edd_subscription' === edd_get_payment_status( $payment_id ) ) {
			return __( 'Renewal', 'templify-recurring' );
		}
