...
?>
		<div class="table table_left table_current_month">
			<table>
				<thead>
					<tr>
						<td colspan="2"><?php _e( 'Subscriptions Created', 'templify-recurring' ) ?></td>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td class="first t"><?php _e( 'This Year', 'templify-recurring' ); ?></td>
						<td class="b"><?php echo $this->get_subscription_count( 'year' ); ?></td>
					</tr>
					<tr>
						<td class="first t"><?php _e( 'This Month', 'templify-recurring' ); ?></td>
						<td class="b"><?php echo $this->get_subscription_count( 'month' ); ?></td>
					</tr>
					<tr>
						<td class="first t"><?php _e( 'Total', 'templify-recurring' ); ?></td>
		...
		<div class="table table_right table_totals">
			<table>
				<thead>
					<tr>
						<td colspan="2"><?php _e( 'Estimated Recurring Revenue', 'templify-recurring' ) ?></td>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td class="t"><?php _e( 'Next 365 Days', 'templify-recurring' ); ?></td>
						<td class="last b"><?php echo $this->get_estimated_revenue( 365 ); ?></td>
					</tr>
					<tr>
						<td class="t"><?php _e( 'Next 30 Days', 'templify-recurring' ); ?></td>
						<td class="last b"><?php echo $this->get_estimated_revenue( 30 ); ?></td>
					</tr>
					<tr>
						<td class="t"><?php _e( 'Total', 'templify-recurring' ); ?></td>
