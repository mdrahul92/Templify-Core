<div class="edd-form-group">
	<div class="edd-form-group__label"><?php esc_html_e( 'Billing Cycle:', 'templify-recurring' ); ?></div>
	<div class="edd-form-group__control">
		...
		printf( esc_html_x( '%1$s then %2$s', 'Initial subscription amount then billing cycle and amount', 'templify-recurring' ), $initial, $billing );
		?>
		<?php if ( $has_tax_rate || $has_tax_amount ) { ?>
			<span>&nbsp;&ndash;&nbsp;</span>
			<a class="edd-item-toggle-next-hidden-row" href=""><?php echo esc_html_x( 'View Details', 'view billing cycle details on single subscription admin page', 'templify-recurring' ); ?></a>
			<div class="edd-item-hidden-row" style="display: none;">
				<?php if ( $has_tax_rate ) { ?>

					<div class="edd-item-hidden-row__item">
						<strong><?php esc_html_e( 'Tax Rate:', 'templify-recurring' ); ?></strong>
						<?php
						...
						printf(
							...
							esc_html_x( '%1$s then %2$s', 'templify-recurring' ),
				...
				if ( $has_tax_amount ) {
					...
					<div class="edd-item-hidden-row__item">
						<strong><?php esc_html_e( 'Tax Amount:', 'templify-recurring' ); ?></strong>
						<?php
						printf(
							/* translators: %1$s Initial tax value. %2$s Billing tax value and cycle length */
							esc_html_x( '%1$s then %2$s', 'Initial subscription tax value then recurring tax value and billing cycle.', 'templify-recurring' ),
