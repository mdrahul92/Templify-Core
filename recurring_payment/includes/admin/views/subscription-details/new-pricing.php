<div class="edd-recurring-subscription-section edd-recurring-subscription__pricing">
	...
	<div class="edd-form-group">
		<label for="products" class="edd-form-group__label">
			<?php esc_html_e( 'Product:', 'templify-recurring' ); ?>
	...
	<fieldset class="edd-form-group edd-recurring-subscription__billing">
		<legend class="edd-form-group__label">
			<?php esc_html_e( 'Price and Billing Cycle:', 'templify-recurring' ); ?>
			<span class="required" aria-hidden="true">*</span>
		</legend>
		<div class="edd-form-group__control">
			<?php
			...
			if ( 'before' === $currency_position ) {
				?>
				<label for="edd_recurring_initial_amount" class="edd-form-group__label screen-reader-text"><?php esc_html_e( 'Initial Amount', 'templify-recurring' ); ?></label>
				...
				<?php echo esc_html_x( 'then', 'Initial subscription amount then billing cycle and amount', 'templify-recurring' ); ?>
				<label for="edd_recurring_recurring_amount" class="edd-form-group__label screen-reader-text"><?php esc_html_e( 'Recurring Amount', 'templify-recurring' ); ?></label>
				<span class="edd-amount-control__currency is-before"><?php echo esc_html( edd_currency_filter( '' ) ); ?></span>
		...
		<div class="edd-form-group__control">
			<label for="edd_recurring_period" class="edd-form-group__label screen-reader-text"><?php esc_html_e( 'Subscription Period', 'templify-recurring' ); ?></label>
