<div class="edd-recurring-subscription-section edd-recurring-subscription__customer">
	...
	<div class="edd-recurring-selected-customer hidden">
		...
		<button type="button" class="button edd-recurring-change-customer"><?php esc_html_e( 'Change customer', 'templify-recurring' ); ?></button>
	</div>

	<div class="subscription-actions">
		<button type="button" class="button button-primary edd-recurring-select-customer"><?php esc_html_e( 'Select existing customer', 'templify-recurring' ); ?></button>
		<button type="button" class="button button-secondary edd-recurring-new-customer"><?php esc_html_e( 'Create new customer', 'templify-recurring' ); ?></button>
	</div>
	...
	<div class="edd-form-group edd-recurring-customer-wrap-existing hidden">
		<label for="edd_recurring_customer_id" class="edd-form-group__label">
			<?php esc_html_e( 'Select Existing Customer:', 'templify-recurring' ); ?>
		...
		?>
		<button type="button" class="button edd-recurring-confirm-customer"><?php esc_html_e( 'Confirm customer', 'templify-recurring' ); ?></button>
	</div>
	<div class="edd-form-group edd-recurring-customer-wrap-new hidden">
		<label for="edd_recurring_customer_email" class="edd-form-group__label">
			<?php esc_html_e( 'New Customer Email:', 'templify-recurring' ); ?>
			<span class="required" aria-hidden="true">*</span>
		</label>
		<input
			type="email"
			...
			name="customer_email"
			value=""
			placeholder="<?php esc_html_e( 'Enter customer email', 'templify-recurring' ); ?>"
			required
		/>
		<button type="button" class="button edd-recurring-confirm-customer"><?php esc_html_e( 'Confirm customer', 'templify-recurring' ); ?></button>
	</div>
