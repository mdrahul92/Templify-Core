...
if ( ! isset( $_GET['notice'] ) || ! is_numeric( $_GET['notice'] ) ) {
	//wp_die( __( 'Something went wrong.', 'templify-recurring' ), __( 'Error', 'templify-recurring' ) );
}
...
?>
<div class="wrap">
	<h1><?php esc_html_e( 'Edit Reminder Notice', 'templify-recurring' ); ?></h1>
	...
	<form id="edd-edit-reminder-notice" action="" method="post">
			...
			<tr>
				...
				<td>
					...
					<ul>
						...
						<li><code>{expiration}</code> <?php esc_html_e( 'The expiration date for the subscription', 'templify-recurring' ); ?></li>
		...
		<p class="submit">
			...
			<input type="submit" value="<?php _e( 'Update Reminder Notice', 'templify-recurring' ); ?>" class="button-primary" />
		</p>
	</form>
</div>
