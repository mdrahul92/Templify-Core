	...
	<tr>
		<th scope="row" valign="top">
			<label for="edd-use-renewals">
				<?php esc_html_e( 'Discount Renewal Orders', 'templify-recurring' ); ?>
			</label>
		</th>
		<td>
			<select id="edd-use-renewals" name="recurring_one_time_discount">
				...
				$options = array(
					...
					''         => sprintf( __( 'Store Default (currently %s)', 'templify-recurring' ), $setting ? __( 'First Order Only', 'templify-recurring' ) : __( 'First Order and Renewals', 'templify-recurring' ) ),
					'first'    => __( 'First Order Only', 'templify-recurring' ),
					'renewals' => __( 'First Order and Renewals', 'templify-recurring' ),
				);
			...
			<p class="description">
				<?php esc_html_e( 'Whether this discount will be used for renewal orders, or restricted to the first order only. Note: this will apply to new subscription/orders only.', 'templify-recurring' ); ?>
			</p>
		</td>
	</tr>
	<?php
