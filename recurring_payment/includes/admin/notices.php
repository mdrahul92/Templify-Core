...
function edd_recurring_warn_subscriber_default_role() {
	...
	<div class="notice error">
		<p>
			<?php
			esc_html_e( 'The default role on your site is the EDD Subscriber role, which will be removed in Recurring 2.12.', 'templify-recurring' );
			echo ' ';
			printf(
				/* translators: 1. opening anchor tag, do not translate; 2. closing anchor tag, do not translate. */
				__( '%1$sPlease update your default user role.%2$s', 'templify-recurring' ),
