...
function edd_recurring_metabox_head( $download_id ) {
	?>
	<th><?php _e( 'Recurring', 'templify-recurring' ); ?></th>
	<th><?php _e( 'Free Trial', 'templify-recurring' ); ?></th>
	<th><?php _e( 'Period', 'templify-recurring' ); ?></th>
	<th><?php echo _x( 'Times', 'Referring to billing period', 'templify-recurring' ); ?></th>
	<th><?php echo _x( 'Signup Fee', 'Referring to subscription signup fee', 'templify-recurring' ); ?></th>
	<?php
}
...
function edd_recurring_price_row_hook( $download_id, $price_id, $args ) {
	...
	<div class="edd-custom-price-option-section">
		...
		if ( version_compare( EDD_VERSION, '2.10.999', '>' ) ) {
			printf( '<span class="edd-custom-price-option-section-title">%s</span>', esc_html__( 'Recurring Payments Settings', 'templify-recurring' ) );
		}
		?>
...
function edd_recurring_metabox_recurring( $download_id, $price_id, $args ) {
	...
	<div class="edd-form-group edd-form-row__column edd-recurring-enabled">
		<label for="edd_variable_prices[<?php echo esc_attr( $price_id ); ?>][recurring]" class="edd-form-group__label"><?php esc_html_e( 'Recurring', 'templify-recurring' ); ?></label>
		<div class="edd-form-group__control">
			<select name="edd_variable_prices[<?php echo esc_attr( $price_id ); ?>][recurring]" id="edd_variable_prices[<?php echo esc_attr( $price_id ); ?>][recurring]" class="edd-form-group__input">
				<option value="no" <?php selected( $recurring, false ); ?>><?php echo esc_attr_e( 'No', 'templify-recurring' ); ?></option>
				<option value="yes" <?php selected( $recurring, true ); ?>><?php echo esc_attr_e( 'Yes', 'templify-recurring' ); ?></option>
			</select>
		</div>
	</div>
	<?php
...
function edd_recurring_metabox_free_trial( $download_id, $price_id, $args ) {
	...
	<fieldset class="edd-form-group edd-form-row__column edd-recurring-free-trial">
		<legend class="edd-form-group__label"><?php esc_html_e( 'Free Trial', 'templify-recurring' ); ?></legend>
		<div class="edd-form-group__control edd-form-group__control--is-inline">
			<div class="eddrecurring-trial-quantity">
				<label for="edd_variable_prices[<?php echo esc_attr( $price_id ); ?>][trial-quantity]" class="screen-reader-text edd-form-group__label"><?php esc_html_e( 'Trial Quantity', 'templify-recurring' ); ?></label>
			...
			<div class="eddrecurring-trial-period">
				<label for="edd_variable_prices[<?php echo esc_attr( $price_id ); ?>][trial-unit]" class="screen-reader-text edd-form-group__label"><?php esc_html_e( 'Trial Period', 'templify-recurring' ); ?></label>
...
function edd_recurring_metabox_period( $download_id, $price_id, $args ) {
	...
	<div class="edd-form-group edd-form-row__column edd-recurring-period">
		<label for="edd_variable_prices[<?php echo esc_attr( $price_id ); ?>][period]" class="edd-form-group__label"><?php esc_html_e( 'Period', 'templify-recurring' ); ?></label>
		<div class="edd-form-group__control">
...
function edd_recurring_metabox_times( $download_id, $price_id, $args ) {
	...
	<div class="edd-form-row__column edd-form-group times edd-recurring-times">
		<label for="edd_variable_prices[<?php echo esc_attr( $price_id ); ?>][times]" class="edd-form-group__label"><?php echo esc_html_x( 'Times', 'Referring to billing period', 'templify-recurring' ); ?></label>
		<div class="edd-form-group__control">
...
function edd_recurring_metabox_signup_fee( $download_id, $price_id, $args ) {
	...
	<div class="edd-form-group edd-form-row__column signup_fee edd-recurring-fee">
		<label for="edd_variable_prices[<?php echo esc_attr( $price_id ); ?>][signup_fee]" class="edd-form-group__label"><?php echo esc_html_x( 'Signup Fee', 'Referring to subscription signup fee', 'templify-recurring' ); ?></label>
		<div class="edd-form-group__control">
			<?php
...
function edd_recurring_metabox_single_recurring( $download_id ) {
	...
	<div class="edd-form-group edd-form-row__column">
		<label for="edd_recurring" class="edd-form-group__label"><?php esc_html_e( 'Recurring', 'templify-recurring' ); ?></label>
		<div class="edd-form-group__control">
			<select name="edd_recurring" id="edd_recurring" class="edd-form-group__input">
				<option value="no" <?php selected( $recurring, false ); ?>><?php esc_attr_e( 'No', 'templify-recurring' ); ?></option>
				<option value="yes" <?php selected( $recurring, true ); ?>><?php esc_attr_e( 'Yes', 'templify-recurring' ); ?></option>
			</select>
		</div>
	</div>
	<?php
...
function edd_recurring_metabox_single_period( $download_id ) {
	...
	?>
	<div class="edd-form-group edd-form-row__column">
		<label for="edd_period" class="edd-form-group__label"><?php esc_html_e( 'Period', 'templify-recurring' ); ?></label>
		<div class="edd-form-group__control">
...
function edd_recurring_metabox_single_times( $download_id ) {
	...
	<div class="edd-form-group edd-form-row__column">
		<label for="edd_times" class="edd-form-group__label"><?php esc_html_e( 'Times', 'templify-recurring' ); ?></label>
		<div class="edd-form-group__control">
...
function edd_recurring_metabox_single_signup_fee( $download_id ) {
	...
	<div class="edd-form-group edd-form-row__column">
		<label for="edd_signup_fee" class="edd-form-group__label"><?php esc_html_e( 'Signup Fee', 'templify-recurring' ); ?></label>
		<div class="edd-form-group__control">
			<?php
			if ( 'before' === $currency_position ) {
				?>
...
function edd_recurring_metabox_trial_options( $download_id ) {
	...
	if( edd_get_option( 'recurring_one_time_discounts' ) ) {
		$one_one_discount_help = ' ' . __( '<strong>Additional note</strong>: with free trials, one time discounts are not supported and discount codes for this product will apply to all payments after the trial period.', 'templify-recurring' );
	}
	...
	<div id="edd_recurring_free_trial_options_wrap" class="edd-form-group"<?php echo $variable_display; ?>>
		...
		<?php if( edd_is_gateway_active( '2checkout' ) || edd_is_gateway_active( '2checkout_onsite' ) ) : ?>
			<p><strong><?php _e( '2Checkout does not support free trial periods. Subscriptions purchased through 2Checkout cannot include free trials.', 'templify-recurring' ); ?></strong></p>
		<?php endif; ?>
		...
		<p>
			...
			<label for="edd_recurring_free_trial">
				<?php esc_html_e( 'Enable free trial for subscriptions', 'templify-recurring' ); ?>
				<span alt="f223" class="edd-help-tip dashicons dashicons-editor-help" title="<?php _e( 'Check this box to include a free trial with subscriptions for this product. When signing up for a free trial, the customer\'s payment details will be taken at checkout but the customer will not be charged until the free trial is completed. <strong>Note:</strong> this only applies when purchasing a subscription. If a price option is not set to recurring, this free trial will not be used.', 'templify-recurring' ); echo $one_one_discount_help; ?>"></span>
			</label>
		</p>
		<fieldset id="edd_recurring_free_trial_options" class="edd-form-group"<?php echo $option_display; ?>>
			<legend class="screen-reader-text"><?php esc_html_e( 'Free Trial Options', 'templify-recurring' ); ?></legend>
			<div class="edd-form-group__control edd-form-group__control--is-inline">
				<div class="edd-recurring-trial-quantity">
					<label for="edd_recurring_trial_quantity" class="edd-form-group__label screen-reader-text"><?php esc_html_e( 'Trial Quantity', 'templify-recurring' ); ?></label>
				...
				<div class="edd-recurring-trial-unit">
					<label for="edd_recurring_trial_unit" class="edd-form-group__label screen-reader-text"><?php esc_html_e( 'Trial Period', 'templify-recurring' ); ?></label>
...
function edd_recurring_metabox_custom_options( $download_id ) {
	...
	<fieldset id="edd_custom_recurring" class="edd_recurring_custom_wrap edd-form-row"<?php echo $display; ?>>
		<legend><?php esc_html_e( 'Recurring Options for Custom Prices', 'templify-recurring' ); ?></legend>
		<p><?php esc_html_e( 'Select the recurring options for customers that pay with a custom price.', 'templify-recurring' ); ?></p>
		<div class="edd-form-group edd-form-row__column">
			<label for="edd_custom_recurring" class="edd-form-group__label"><?php esc_html_e( 'Recurring', 'templify-recurring' ); ?></label>
			<div class="edd-form-group__control">
		...
		<div class="edd-form-group edd-form-row__column">
			<label for="edd_custom_period" class="edd-form-group__label"><?php esc_html_e( 'Period', 'templify-recurring' ); ?></label>
			<div class="edd-form-group__control">
		...
		<div class="edd-form-group edd-form-row__column times">
			<label for="edd_custom_times" class="edd-form-group__label"><?php esc_html_e( 'Times', 'templify-recurring' ); ?></label>
			<div class="edd-form-group__control">
		...
		<div class="edd-form-group edd-form-row__column signup_fee">
			<label for="edd_custom_signup_fee" class="edd-form-group__label"><?php esc_html_e( 'Signup Fee', 'templify-recurring' ); ?></label>
			<div class="edd-form-group__control">
				<?php
				if ( 'before' === $currency_position ) {
					?>
...
?>
		<div id="edd-order-subscriptions" class="postbox">
			<h3 class="hndle">
				<span><?php _e( 'Subscriptions', 'templify-recurring' ); ?></span>
			</h3>
			<div class="inside">
				...
				<?php foreach( $subs as $sub ) : ?>
					...
					<?php if( $payments ) : ?>
						<p><strong><?php _e( 'Associated Payments', 'templify-recurring' ); ?>:</strong></p>
...
function edd_recurring_subscription_section( $sections, $order ) {
	if ( ! edd_is_add_order_page() ) {
		...
		if ( $is_parent_order || $is_renewal_order ) {
			$sections[] = array(
				'id'       => 'subscriptions',
				'label'    => __( 'Subscriptions', 'templify-recurring' ),
				'icon'     => 'update',
...
function edd_recurring_display_parent_payment( $payment_id = 0 ) {
	...
	<div id="edd-order-subscription-payments" class="postbox">
		<h3 class="hndle">
			<span><?php esc_html_e( 'Subscription', 'templify-recurring' ); ?></span>
		</h3>
		<div class="inside">
			<p>
			...
			<p><?php esc_html_e( 'Parent Payment', 'templify-recurring' ); ?>: <?php printf( '<a href="%s">%s</a>', esc_url( $parent_url ), esc_html( edd_get_payment_number( $payment->parent_payment ) ) ); ?></p>
		</div><!-- /.inside -->
...
?>
		<div class="edd-subscription-tx-id edd-admin-box-inside">
			<?php foreach( $subs as $sub ) : ?>
				...
				<p>
					<span class="label"><?php _e( 'Subscription TXN ID:', 'templify-recurring' ); ?></span>&nbsp;
