...
class EDD_Recurring_Reminders {
	...
	*/
	public function get_notice_periods() {
		$periods = array(
			'today'    => __( 'The day of the renewal/expiration', 'templify-recurring' ),
			'+1day'    => __( 'One day before renewal/expiration', 'templify-recurring' ),
			'+2days'   => __( 'Two days before renewal/expiration', 'templify-recurring' ),
			'+3days'   => __( 'Three days before renewal/expiration', 'templify-recurring' ),
			'+1week'   => __( 'One week before renewal/expiration', 'templify-recurring' ),
			'+2weeks'  => __( 'Two weeks before renewal/expiration', 'templify-recurring' ),
			'+1month'  => __( 'One month before renewal/expiration', 'templify-recurring' ),
			'+2months' => __( 'Two months before renewal/expiration', 'templify-recurring' ),
			'+3months' => __( 'Three months before renewal/expiration', 'templify-recurring' ),
			'-1day'    => __( 'One day after expiration', 'templify-recurring' ),
			'-2days'   => __( 'Two days after expiration', 'templify-recurring' ),
			'-3days'   => __( 'Three days after expiration', 'templify-recurring' ),
			'-1week'   => __( 'One week after expiration', 'templify-recurring' ),
			'-2weeks'  => __( 'Two weeks after expiration', 'templify-recurring' ),
			'-1month'  => __( 'One month after expiration', 'templify-recurring' ),
			'-2months' => __( 'Two months after expiration', 'templify-recurring' ),
			'-3months' => __( 'Three months after expiration', 'templify-recurring' )
		);
	...
	*/
	public function get_notice_types() {
		$types = array(
			'renewal'    => __( 'Renewal', 'templify-recurring' ),
			'expiration' => __( 'Expiration', 'templify-recurring' ),
		);
	...
	*/
	public function get_notice( $notice_id = 0 ) {
		...
		$defaults = array(
			'subject'      => __( 'Your Subscription is About to Renew', 'templify-recurring' ),
			'send_period'  => '+1month',
			'message'      => 'Hello {name},
	...
	*/
	...
	Your subscription for {subscription_name} will expire on {expiration}.';
			...
			$notices[1] = array(
				'send_period' => '+1month',
				'subject'     => __( 'Your Subscription is About to Expire', 'templify-recurring' ),
				'message'     => $message,
				'type'        => 'expiration',
			);
		}
	...
	*/
	public function send_test_notice( $notice_id = 0 ) {
		...
		$message  = ! empty( $notice['message'] ) ? $notice['message'] : __( "**THIS IS A DEFAULT TEST MESSAGE - Notice message was not retrieved.**\n\nHello {name},\n\nYour subscription for {subscription_name} will renew or expire on {expiration}.", 'templify-recurring' );
		$message  = $this->filter_test_notice( $message );
		$subject  = ! empty( $notice['subject'] ) ? $notice['subject'] : __( 'Default Subject Message - Your Subscription is About to Renew or Expire', 'templify-recurring' );
